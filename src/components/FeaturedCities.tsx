...
export default function FeaturedCities({ className }: { className?: string }) {
  return (
    <section id="featured-destinations" className={cn("py-24 bg-white dark:bg-neutral-900", className)}>
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {featuredCities.map((city, index) => {
            // Make the first and 6th items span 2 columns
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isLarge ? "md:col-span-2 lg:col-span-2 aspect-[16/9] lg:aspect-auto lg:h-[400px]" : "aspect-[4/5] lg:h-[400px]"
                )}
              >
                <img
                  src={city.image}
